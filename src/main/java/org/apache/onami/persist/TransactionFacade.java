...
interface TransactionFacade {
  ...
  /**
   * Adds a callback that will be called after this transaction has been committed both preCommit() and postCommit().
   * If this transaction is an inner transaction, the callback will not be called until any outer transaction has also
   * been committed.
